...
urlpatterns = [
    ...
    path(
        "magic-link/", magic_link_views.magic_link_login_page, name="magic_link_login"
    ),
    path(
        "magic-link/generate/",
        magic_link_views.generate_magic_link,
        name="magic_link_generate",
    ),
    path(
        "magic-link/verify/<str:token>/",
        magic_link_views.verify_magic_link,
